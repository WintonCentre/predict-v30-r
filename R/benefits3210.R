...
#' @export benefits3210
#'
#' @examples benefits3210()

benefits3210 <- function(age.start.in  = 65,
...
{
  locals3110 <- list2env(benefits32(
    age.start.in,
    screen.in,
    size.in,
    grade.in,
  ...
  # NB. We could inherit the coeffs from benefits32() with a bit of refactoring
