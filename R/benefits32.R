...
#' Title Calculate Predict3.2 treatment benefits given patient details
#'
...
)
{
  ...
  with(locals30, {
    ...
    r.base.br  <- ifelse(er==0, 0.55, 0.7) # log(1/((1-r.prop) + r.prop*r.breast))
    r.base.oth <- -0.062 # log(1/((1-r.prop) + r.prop*(r.other^2))) # Assume 2 Gy average heart dose
